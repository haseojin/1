...
<div id="header2">
	<p id="header2p">
		<?php
			echo $_SESSION['n_name']."(".$_SESSION['id'].")님의 정보수정.";
		?>
	</p>
</div>
...
<section>
	<article>
	<br><br><br>
	<form method=post action="./change_member_post.php" name=form_name>
		<div id="cmember_form">
			<div id="big_label">회원정보</div>
			<div class="line"></div>
			<div id="middle">
				<dl>
					<dt class="label1"><label>변경할 닉네임</label></dt>
					...
					<dt class="label1"><label>변경할 전화번호</label></dt>
					<dd>
						<select name="tel1">
							<option>010</option>
							<option>02</option>
				...
				<div id="btns2">
					<p><input type="button"  class="icon_login" name="formcheck" value="변   경" OnClick="form_check()"><input type="reset" class="icon_login" value="취   소"></p>
				</div>
			</div>
		</div>
	</form>
