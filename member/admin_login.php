...
<body>	
		...
		<section>
			<article>
			<br><br><br>
			<form method=post action="./admin_check.php" name=fname>
				<div id="alogin_form">
				<div id="big_label">관리자 로그인</div>
				<div class="line"></div>
					<div id="middle">
					<dl>
						<dt class="label1"><label>아이디</label></dt>
						<dd><input type=text name="aid" size=40 style="width:200"></dd>
						<dt class="label1"><label>비밀번호</label></dt>
						<dd><input type=password name="apwd" size=40 style="width:200">&nbsp;</dd>
					</dl>
